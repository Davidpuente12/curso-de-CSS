...
// FUNCION CLAMP
const elemento = document.querySelector("#item-to-clamp p");
const estilo = window.getComputedStyle(elemento).fontSize;
document.getElementById("tamaño-letra").textContent = estilo;
